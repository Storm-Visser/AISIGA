...
namespace AISIGA.Program.Tests.MethodTests
{
    static class CrossoverTest
    {
        public static void TestCrossover()
        {
            ...
            testABP1.AssignRandomFeatureValuesAndMultipliers([1.9, 1.9, 1.9], [1.0, 1.0, 1.0], config.UseHyperSpheres);
            testABP2.AssignRandomFeatureValuesAndMultipliers([2.9, 2.9, 2.9], [2.0, 2.0, 2.0], config.UseHyperSpheres);
